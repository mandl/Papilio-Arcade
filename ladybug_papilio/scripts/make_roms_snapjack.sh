...
export rom_path_src=../roms/snapjack
export rom_path=../build
export romgen_path=../romgen_source
#mkdir $rom_path
echo 0a776aeca3947a6f29d527018f5182e758b50c5d 10-1.f4
sha1sum $rom_path_src/10-1.f4 
echo e267726ba59e9a42ac89dd22eb1508ad21fd32ac 10-2.k1
sha1sum $rom_path_src/10-2.k1 
echo 7cf59b7a37c156640d6ea91554d1c4276c1780e0 10-3.c4
sha1sum $rom_path_src/10-3.c4
echo 461662719bc7f1cf21c41759f4832a92b0fdb4f2 sj0.h7
sha1sum $rom_path_src/sj0.h7
echo 85e4ebbbe8e8d6c79a14387d7a6818abc9430037 sj1.c4
sha1sum $rom_path_src/sj1.c4
echo 38409e2318dee3cc0678d4ee9e93d9b895883df6 sj9.f7
sha1sum $rom_path_src/sj9.f7

rm -f $rom_path/cpu1.bin
rm -f $rom_path/cpu2.bin
rm -f $rom_path/cpu3.bin

cat $rom_path_src/sj1.c4 $rom_path_src/sj2.d4 >> $rom_path/cpu1.bin
cat $rom_path_src/sj3.e4 $rom_path_src/sj4.h4 >> $rom_path/cpu2.bin
cat $rom_path_src/sj5.j4 $rom_path_src/sj6.k4 >> $rom_path/cpu3.bin
